(async function(Scratch) {
    ...
    Extension.prototype["onfocushat"] = async (args, util) => {};
    ...
    Extension.prototype["focused"] = async (args, util) => {
    ...
    Extension.prototype["unfocus"] = async (args, util) => {
